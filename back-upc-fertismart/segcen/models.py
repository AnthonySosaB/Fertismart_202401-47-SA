...
from enticen.models import Application, CreatedUpdatedDeleted

User = get_user_model()

Group.add_to_class('user_manual',
                   models.FileField(upload_to='file/user_manual',
                                    null=True, blank=True,
                                    verbose_name="User Manual"))
User.add_to_class('created_date', models.DateTimeField(auto_now_add=True, editable=False, null=True))
User.add_to_class('updated_date', models.DateTimeField(editable=False, null=True))
User.add_to_class('deleted_date', models.DateTimeField(editable=False, null=True))
User.add_to_class('created_by',
                  models.ForeignKey('self',
                                    related_name="%(app_label)s_%(class)s_adder",
                                    on_delete=models.PROTECT,
                                    null=True))
User.add_to_class('updated_by',
                  models.ForeignKey('self',
                                    related_name="%(app_label)s_%(class)s_editor",
                                    on_delete=models.PROTECT,
                                    null=True))
User.add_to_class('deleted_by',
                  models.ForeignKey('self',
